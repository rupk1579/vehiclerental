...
public class TestCase3 extends BaseTest {
    ...
    void case2() {
        ...
        //user1 Book and make Failed payment
        try {
            BookingInfo bookingInfo = bookedVehicleService.bookParticularVehicle(vehicle1, 400.00);
            paymentService.makeFailedPayment(bookingInfo, PaymentMode.UPI, PaymentStatus.FAILED);
        ...
        //now user2 can Book and make SuccessFul payment
        try {
            BookingInfo bookingInfo = bookedVehicleService.bookParticularVehicle(vehicle1, 400.00);
